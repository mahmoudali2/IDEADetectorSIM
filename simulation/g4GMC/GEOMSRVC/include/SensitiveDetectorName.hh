...
public:
  enum SDtype { DCHtracker=0, DCHSWires,  DCHFWires, DCHWalls, SVXtracker, SIWRPtracker, PSHWtracker, PHCVtcounter, PHCVradiator, DRFPIcalo, MUSPCtracker };
  ...
  static char const * SIWRPTrackerRO(){
    return name[SIWRPtracker];
  }
